  ...
  function endDay(died) {
    ...
    if (!died) {
      ...
      if (day < 5) {
        ...
        instructions.innerHTML = `<h2>You have finished the entire week!</h2><p>You have caught ${fishTracker[0]} fishes, ${fishTracker[1]} rare fishes, ${fishTracker[2]} trash and ${fishTracker[2]} jellyfishes.<br>Your Total Score: ${score}<a href="about:blank" style="color: black;">Convert your points>></a></p>`;
        day = 0;
      }
    } else {
      day = 0;
